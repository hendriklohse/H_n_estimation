...
from calculate_H import create_CDF
...
def run_all(n, nruns, ple):
	...
	H_n_CDF = create_CDF(clus_dict=locClus, dict_length=len(locClus.keys()), n=n, ple=ple)
	#
	# sample_ = simulate3(nruns=nruns, probability_list=H_n)
	sample_ = sample_from_CDF(cdf_list=H_n_CDF, nruns=nruns)

	estimates_dict = run_tail_estimation(dimension=1, n=n, nruns=nruns, ple=2.5, sample=sample_, testing=1)
